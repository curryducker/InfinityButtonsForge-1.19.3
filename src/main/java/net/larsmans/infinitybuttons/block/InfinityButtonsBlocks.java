...
public class InfinityButtonsBlocks {
    ...
    private static RegistryObject<Block> registerWoodenLargeButton(String wood) {
        return registerBlock(wood + "_large_button", () -> new WoodenButton(BlockBehaviour.Properties.of(Material.DECORATION).strength(0.5f).noCollission().sound(SoundType.WOOD), true, false));
    }

    private static RegistryObject<Block> registerNetherWoodenLargeButton(String wood) {
        return registerBlock(wood + "_large_button", () -> new WoodenButton(BlockBehaviour.Properties.of(Material.DECORATION).strength(0.5f).noCollission().sound(SoundType.NETHER_WOOD), true, true));
    }
    ...
    private static RegistryObject<Block> registerNetherPlankSecretButton(String wood, MaterialColor materialColor) {
        return registerBlock(wood + "_plank_secret_button", () -> new PlankSecretButton(BlockBehaviour.Properties.of(Material.NETHER_WOOD, materialColor).strength(2.0f, 3.0f).noOcclusion().sound(SoundType.NETHER_WOOD), byName(wood + "_planks")));
    }
